...
fun MainScreen(
    ...
    var selectedNavItem by remember { mutableStateOf(0) } // 0 是首頁, 1 是媒體庫
    ...
    BackHandler(
        enabled = !isPlayerExpanded && !isSettingsOpen && selectedNavItem == 0 &&
    ...
    // 雙擊返回鍵退出 App
    BackHandler(enabled = !isPlayerExpanded && !isSettingsOpen &&
            !(selectedNavItem == 0 && (homeVerticalListState.firstVisibleItemIndex > 0 || homeVerticalListState.firstVisibleItemScrollOffset > 0))) {
        ...
        Scaffold(
            ...
            bottomBar = {
                ...
                Column(
                    ...
                    Row(
                        ...
                        // 首頁按鈕
                        val isHomeSelected = selectedNavItem == 0
                        Column(
                            modifier = Modifier
                                .weight(1f)
                                .fillMaxHeight()
                        ...
                        // 媒體庫按鈕
                        val isLibrarySelected = selectedNavItem == 1
                        Column(
                            modifier = Modifier
                                .weight(1f)
                                .fillMaxHeight()
            ...
            Box(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxSize()
                        .graphicsLayer { alpha = if (selectedNavItem == 0) 1f else 0f }
                ) {
                    if (selectedNavItem == 0 || true) { // 保持組合但控制顯示
                        HomeScreen(
                            songs = allSongs,
                            ...
                            isOverlayOpen = isPlayerExpanded || isSettingsOpen,
                ...
                Box(
                    modifier = Modifier
                        .fillMaxSize()
                        .graphicsLayer { alpha = if (selectedNavItem == 1) 1f else 0f }
                ) {
