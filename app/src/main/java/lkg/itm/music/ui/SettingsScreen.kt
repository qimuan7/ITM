    ...
    Column(
        ...
        LazyColumn(
            ...
            item {
                ...
                SettingsSectionHeader(title = stringResource(id = R.string.library))
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        ...
                        Text(
                            text = stringResource(id = R.string.itunes_folder_desc),
                            fontSize = 13.sp,
                            color = Color.Gray
                        )
                    }
                ...
                SettingsSectionHeader(title = stringResource(id = R.string.change_recommendations))
                Spacer(modifier = Modifier.height(8.dp))
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        Button(
                            ...
                            Spacer(modifier = Modifier.width(8.dp))
                            Text(
                                text = stringResource(id = R.string.refresh_daily_recommendations),
                        ...
                        Text(
                            text = stringResource(id = R.string.refresh_daily_desc),
                            fontSize = 13.sp,
                            color = Color.Gray
                        )
                    }
...
fun ThemeOptionButton(
    ...
    Button(
        ...
        modifier = modifier,
        colors = ButtonDefaults.buttonColors(
            containerColor = if (isSelected) (if (isDark) Color.White else Color.Black) else if (isDark) MaterialTheme.colorScheme.surfaceVariant else Color(0xFFD9D9D9),
            contentColor = if (isSelected) (if (isDark) Color.Black else Color.White) else MaterialTheme.colorScheme.onSurfaceVariant
        ),
        shape = RoundedCornerShape(10.dp)
    ) {
